        ...
        <div id="bo_v_source">
          ...
          <div id="bo_v_file" class="bo_v_source_ct">
            <ul>
              ...
              <li>
                <div class="file-name">
                  <img src="/source/img/icon-file.png" alt="">
                  <span><?php echo $view['file'][$i]['source'] ?>(<?php echo $view['file'][$i]['size'] ?>)</span>
                </div>
                <a href="<?php echo $view['file'][$i]['href'];  ?>" class="view_file_download">
                  <!-- <span class="bo_v_file_size"><?php //echo $view['file'][$i]['content'] ?> </span> -->
                  <span>다운로드</span>
