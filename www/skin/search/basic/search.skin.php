...
<div class="contents_wrap search_result_wr">
    ...
    <div class="wrapper">
      <div class="sub-visual-in">
        <div class="sub-visual-txt-wr">
          ...
          <p class="sub-visual-tit">Search</p>
        </div>
      </div>
    </div>
  </div>
            ...
            <form name="fsearch" onsubmit="return fsearch_submit(this);" method="get">
              ...
              <div class="bo_sch_ct">
                ...
                <div class="sch_bar">
                  ...
                  <input type="text" name="stx" value="<?php echo $text_stx ?>" id="stx" required class="sch_input" size="40" placeholder="검색어를 입력해주세요.">
                </div>
                   ...
                   ?>
                      ...
                      <li>
                          <div class="sch_tit">
                              ...
                              <a href="<?php echo get_pretty_url($search_table[$idx], '', $search_query); ?>" target="_blank" class="pop_a"><i class="fa fa-window-restore" aria-hidden="true"></i><span class="sound_only">새창</span></a>
